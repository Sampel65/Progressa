...
enum MockData {
    ...
    static let dashboardBadges: [DashboardBadge] = [
        DashboardBadge(title: "Mastery", subtitle: "Complete stages", gemColor: .blue),
        DashboardBadge(title: "Streak", subtitle: "Stay consistent", gemColor: .orange),
        DashboardBadge(title: "Milestone", subtitle: "Hit key goals", gemColor: .purple),
    ]
